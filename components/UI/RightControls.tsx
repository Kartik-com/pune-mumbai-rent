  ...
  return (
    <div className="fixed right-4 md:top-[84px] top-[140px] flex flex-col md:gap-[10px] gap-2 z-[1000] pointer-events-auto">
      ...
      <button onClick={onToggleStyle} title="Switch Map Style" className="w-9 h-9 md:w-[42px] md:h-[42px] rounded-[10px] glass glass-hover flex items-center justify-center text-text2 hover:text-accent shadow-2xl transition-all">
        {mapStyle === 'dark' ? (
          <svg width="16" height="16" md:width="18" md:height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>
        ) : (
      ...
      <button onClick={onToggleMetro} title="Toggle Metro" className={`w-9 h-9 md:w-[42px] md:h-[42px] rounded-[10px] hidden sm:flex items-center justify-center shadow-2xl transition-colors ${showMetro ? 'bg-accent text-bg border-accent' : 'glass glass-hover text-text2 hover:text-text1'}`}>
        <svg fill="currentColor" width="16" height="16" md:width="18" md:height="18" viewBox="0 0 24 24"><path d="M12 2c-4 0-8 1-8 4v10a2 2 0 0 0 2 2h2v2a1 1 0 1 0 2 0v-2h6v2a1 1 0 1 0 2 0v-2h2a2 2 0 0 0 2-2V6c0-3-4-4-8-4zm-4 12a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm8 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zM6.5 9V6c0-1.8 2.5-2.5 5.5-2.5S17.5 4.2 17.5 6v3h-11z"/></svg>
      </button>

      {/* Heatmap */}
      <button onClick={onToggleHeatmap} title="Rent Heatmap" className={`w-9 h-9 md:w-[42px] md:h-[42px] rounded-[10px] flex items-center justify-center shadow-2xl transition-colors ${showHeatmap ? 'bg-orange-500 text-white border-none' : 'glass glass-hover text-text2 hover:text-text1'}`}>
      ...
      <button onClick={onLocate} title="Locate Me" className="w-9 h-9 md:w-[42px] md:h-[42px] rounded-[10px] glass glass-hover flex items-center justify-center text-text2 hover:text-accent shadow-2xl transition-all">
        <svg width="16" height="16" md:width="18" md:height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="2" x2="12" y2="6"/><line x1="12" y1="18" x2="12" y2="22"/><line x1="2" y1="12" x2="6" y2="12"/><line x1="18" y1="12" x2="22" y2="12"/></svg>
      </button>
